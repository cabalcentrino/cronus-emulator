 ...
 */
public class PendingHandler extends AbstractOpcodeHandler {
    protected final NullHandler nullHandler;
    
    public PendingHandler(short opcodeHandled) {
        super(opcodeHandled);
        this.nullHandler = NullHandler.getInstance();
    }
    
    @Override
    protected Boolean handleValue(Packet value) {
        return nullHandler.handle(value);
    }    
}
