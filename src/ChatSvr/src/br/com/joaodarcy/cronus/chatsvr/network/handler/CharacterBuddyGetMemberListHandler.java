 ...
 */
final class CharacterBuddyGetMemberListHandler extends ChatOpcodeHandler {

    public CharacterBuddyGetMemberListHandler() {
        super((short)0x01CE, SessionState.LOGGED_IN);
    }    
        
    @Override
    protected Boolean handleValue(Packet packet) {
        final ChatSession session = getCurrentSession();
        final UInt32 unk = packet.getUInt32();
