 ...
 */
final class AccountAuthAccountHandler extends ChatOpcodeHandler {

    public AccountAuthAccountHandler() {
        super((short)0x192, SessionState.HANDSHAKED);
    }
    
    @Override
    protected Boolean handleValue(Packet packet) {
        UInt32 accountId = packet.getUInt32(); // ??
        ...
        // TODO
        session.changeSessionState(SessionState.ACCOUNT_VERIFIED);
