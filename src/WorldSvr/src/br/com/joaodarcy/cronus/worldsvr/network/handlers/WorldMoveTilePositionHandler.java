 ...
 */
public class WorldMoveTilePositionHandler extends ServerOpcodeHandler {

    public WorldMoveTilePositionHandler() {
        super((short)0x00C2, ClientState.IN_WORLD);
    }
    ...
    protected Boolean handleValue(Packet value) {
        int unk = value.getInt();
        
        short x = value.getShort();
        short y = value.getShort();
