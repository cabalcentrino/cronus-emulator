...
import br.com.joaodarcy.cronus.worldsvr.item.ItemPropertie;
 ...
 */
public final class ItemPropertieSQLType implements Type {

    @Override
    public Class<?> getTypeClass() {
        return ItemPropertie.class;
    }
    ...
    public Object getValue(ResultSet resultSet, String columnLabel) throws SQLException {
        return ItemPropertie.values()[resultSet.getInt(columnLabel)];
    }

    @Override
    public Object getValue(ResultSet resultSet, int columnIndex) throws SQLException {
        return ItemPropertie.values()[resultSet.getInt(columnIndex)];
    }

    @Override
    public Object getValue(CallableStatement callableStatement, int parameterIndex) throws SQLException {
        return ItemPropertie.values()[callableStatement.getInt(parameterIndex)];
    }
