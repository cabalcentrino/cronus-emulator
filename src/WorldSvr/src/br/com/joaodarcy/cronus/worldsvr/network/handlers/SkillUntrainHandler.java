 ...
 */
public class SkillUntrainHandler extends ServerOpcodeHandler {

    public SkillUntrainHandler() {
        super((short)0x010f, ClientState.IN_WORLD);
    }    
    
    @Override
    protected Boolean handleValue(Packet value) {
        getCurrentSession().sendPacket(makeBooleanPacket(true));        
        return true;
    }
