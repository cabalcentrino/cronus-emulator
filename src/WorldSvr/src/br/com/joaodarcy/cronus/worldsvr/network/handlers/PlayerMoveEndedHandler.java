 ...
 */
public class PlayerMoveEndedHandler extends ServerOpcodeHandler {

    public PlayerMoveEndedHandler() {
        super((short)0x00BF, ClientState.IN_WORLD);
    }
    ...
    protected Boolean handleValue(Packet value) {
        ...
        session.getPlayer().relocate(newX, newY);
