 ...
 */
public class NationType implements Type {
    ...
    public Object getValue(ResultSet resultSet, String columnLabel) throws SQLException {
        return Nation.getNationById(UInt8.valueOf(resultSet.getByte(columnLabel)));
    }

    @Override
    public Object getValue(ResultSet resultSet, int columnIndex) throws SQLException {
        return Nation.getNationById(UInt8.valueOf(resultSet.getByte(columnIndex)));
    }

    @Override
    public Object getValue(CallableStatement callableStatement, int parameterIndex) throws SQLException {
        return Nation.getNationById(UInt8.valueOf(callableStatement.getByte(parameterIndex)));
    }
