 ...
 */
final class WorldExitSelectCharacterHandler extends ServerOpcodeHandler {
        
    public WorldExitSelectCharacterHandler() {
        super((short)0x03D9, ClientState.IN_WORLD);
    }    
    ...
    protected Boolean handleValue(Packet value) {
        ...
        session.sendPacket(makeBooleanPacket(canExit));
