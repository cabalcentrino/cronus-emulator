 ...
 */
public class WeaponRankType implements Type {

    @Override
    public Class<?> getTypeClass() {
        return WeaponRank.class;
    }
    ...
    public Object getValue(ResultSet resultSet, String columnLabel) throws SQLException {
        return WeaponRank.getWeaponRankById(UInt8.valueOf(resultSet.getByte(columnLabel)));
    }

    @Override
    public Object getValue(ResultSet resultSet, int columnIndex) throws SQLException {
        return WeaponRank.getWeaponRankById(UInt8.valueOf(resultSet.getByte(columnIndex)));
    }

    @Override
    public Object getValue(CallableStatement callableStatement, int parameterIndex) throws SQLException {
        return WeaponRank.getWeaponRankById(UInt8.valueOf(callableStatement.getByte(parameterIndex)));
    }
