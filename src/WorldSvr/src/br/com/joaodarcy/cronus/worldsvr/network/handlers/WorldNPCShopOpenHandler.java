 ...
 */
final class WorldNPCShopOpenHandler extends ServerOpcodeHandler {

    public WorldNPCShopOpenHandler() {
        super((short)0x0885, ClientState.IN_WORLD);
    }
    ...
    private Packet makeResponse(WorldSession session){
